...
public class GoProHelper {
	...
	public GoProHelper(String ipAddress, Integer port, String password) {
		...
		System.out.println("Using ipAddress " + ipAddress);
	...
	public CamFields getCameraInfo() {
		...
		GoProProtocolParser localGoProProtocolParser;
		try {
			System.out.print("sending call to ");
			System.out.println(this.mCameraAddress + Operations.CAMERA_CV + "?t=" + this.getToken());
			byte[] arrayOfByte = sendGET(this.mCameraAddress
			...
			{
				System.out.print("getCameraInfo result code: ");
				System.out.println(localGoProProtocolParser.extractResultCode());
			}
		} catch (Exception localException) {
			System.out.print("getCameraInfo threw exception: ");
